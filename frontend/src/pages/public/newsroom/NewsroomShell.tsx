    ...
    <div className="min-h-screen bg-white dark:bg-[#050d16]">
      <header className="border-b border-slate-200 bg-[var(--brand-ink)] text-white dark:border-white/10">
        <div className="site-container flex flex-col gap-5 py-7 lg:flex-row lg:items-center lg:justify-between">
          <div><Link to="/newsroom" className="text-2xl font-black tracking-tight sm:text-3xl">Medanfo Newsroom</Link><p className="mt-1 text-sm text-slate-300">Stories, notices and moments from our school community</p></div>
      ...
      <section className="border-t border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-white/[.025]">
        <div className="site-container grid gap-8 py-12 md:grid-cols-3">
          <div><h2 className="font-black text-slate-900 dark:text-white">Medanfo Newsroom</h2><p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-300">Official school stories, announcements, events and community updates.</p></div>
